...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        /* Challenge 1. It crashes when you open the app. */
        house1 = House(address: "Some address", price: "$12,000", bedrooms: "3 bedrooms")
        setUpLeftSideUI()
        setUpRightSideUI()
    }
    ...
    func setUpRightSideUI() {
        if house2 == nil {
            ...
            /* Challenge 2. If the user adds a second house to compare, none of the labels or images show up. */
